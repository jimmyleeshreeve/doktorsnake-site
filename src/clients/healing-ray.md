...
This distance influence working is geared to bring healing and well-being.

It is remote energy work designed to:

- restore the balance in your energy centres.
- recalibrate the body/mind system.
- revitalise vital nodes and pathways

## How It Works

At twilight, I head to an ancient Neolithic zone in Suffolk — barrow-rooted land where the ether runs close to the surface.

There I enter trance:

tune into the field
call on spirit and ancestral allies
push healing energies into the ether with targeted force

and from there, restorative "rays" are carried, aligned, and set in motion.

If you have a negative miasma surrounding you, especially in your subtle body (causing you sickness or sapping you of vitality), this can be removed and "earthed".

This method allows me to strengthen your subtle body and create a psychic shield around you, keeping out detrimental energies or malign attachments.

Psionics workings of this nature are powerful. Many of my clients commission me to conduct Healing Ray workings on a regular basis - often for "good measure" to ensure their energy centers are in balance.
